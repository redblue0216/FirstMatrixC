...
void main(void)
{
    ...
    **矩阵LU分解运算测试
    */
    Matrix g6 = CreateMatrix(3,3);
    float array_g6[] = {0,14,2,
                        4,4,9,
                        -3,2,13};  
    SetMatrixData(g6,array_g6);
    SetMatrixElement(g6,1,1,-6);
    float g6_element = GetMatrixElement(g6,1,1);
    printf("==============================>>>>>> This is a MatrixDecompositionLU function test!\n");
    printf("The test element of g6 matrix is %f\n",g6_element);
    LUMatrix lu_matrix;
    lu_matrix = MatrixDecompositionLU(g6);
    float l_matrix_element = GetMatrixElement(lu_matrix.L,3,3);
    printf("The test  l element of g6_lu matrix is %f\n",l_matrix_element);
    float u_matrix_element = GetMatrixElement(lu_matrix.U,2,3);
    printf("The test u element of g6_lu matrix is %f\n",u_matrix_element);
    /*
    **矩阵Cholesky分解运算测试
    */
   printf("==============================>>>>>> This is a MatrixDecompositionCholesky function test!\n");
   Matrix g7 = CreateMatrix(4,4);
   float array_g7[] = {5,7,6,5,
                       7,10,8,7,
                       6,8,10,9,
                       5,7,9,10};
    SetMatrixData(g7,array_g7);
    CholeskyMatrix cholesky_matrix;
    cholesky_matrix = MatrixDecompositionCholesky(g7);
    printf("The test element of g7 matrix is %f\n",g7.data[9]);
    printf("The test l element of g7_cholesky matrix is %f\n",cholesky_matrix.L.data[9]);
    /*
    **矩阵QR分解运算测试
    */
   printf("==============================>>>>>> This is a MatrixDecompositionQR function test!\n");
   Matrix g8 = CreateMatrix(4,3);
   float array_g8[] = {1,1,-1,
                       2,1,0,
                       1,-1,0,
                       -1,2,1};
    SetMatrixData(g8,array_g8);
    QRMatrix qr_matrix;
    qr_matrix = MatrixDecompositionQR(g8);
